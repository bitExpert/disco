...
use bitExpert\Techno\Proxy\LazyBean\LazyBeanFactory;
...
{
    /**
     * Creates a new {@link \bitExpert\Techno\Proxy\Configuration\MethodGenerator\BeanMethod}.
     *
    ...
    public static function fromReflection(MethodReflection $reflectionMethod): MethodGenerator
    {
         ...
         * the {@link \bitExpert\Techno\AnnotationBeanFactory} calls the generated methods without any parameters we
